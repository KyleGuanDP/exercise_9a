...
class ToDoItemDetailsWidget extends StatefulWidget {
  const ToDoItemDetailsWidget({super.key , required this.title,required this.description,required this.image, }) ;
...
class _ToDoItemDetailsWidgetState extends State<ToDoItemDetailsWidget> with TickerProviderStateMixin {
...
final animationsMap = <String, AnimationInfo>{};
  ...
  void initState() {
    ...
    _model = createModel(context, () => ToDoItemDetailsModel());
          ...
          animationsMap.addAll({          'imageOnPageLoadAnimation': AnimationInfo(
...
body: SafeArea(
      ...
      children: [Hero(tag:  widget.image!  , transitionOnUserGestures: true, child: ClipRRect(
...
Padding(
       ...
       valueOrDefault<String>(widget.description, 'Desc for ToDo Item',)  ,
